...
Personal archive of [anthropics/skills](https://github.com/anthropics/skills) focused on document handling skills (docx, pdf, pptx, xlsx) and core Agent Skills patterns.
